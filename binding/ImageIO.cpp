...
void init_io(py::module &m) {
    ...
    py::class_<MipiRaw10Reader, ImageReader> mipiRaw10Reader(m_io, "MipiRaw10Reader");
    mipiRaw10Reader.def("read16u", &MipiRaw10Reader::read16u);

    py::class_<MipiRaw12Reader, ImageReader> mipiRaw12Reader(m_io, "MipiRaw12Reader");
    ...
    m_io.def("makeReader", [](const std::string &inputPath, const py::object &metadata) {
    ...
    py::class_<MipiRaw10Writer, ImageWriter> mipiRaw10Writer(m_io, "MipiRaw10Writer");
    mipiRaw10Writer.def("write", [](MipiRaw10Writer &self, const Image16u &image) { self.write(image); });

    py::class_<MipiRaw12Writer, ImageWriter> mipiRaw12Writer(m_io, "MipiRaw12Writer");
    ...
    m_io.def("makeWriter", [](const std::string &outputPath, const py::object &write_options) {
        if (!write_options.is(py::none())) {
            ImageWriter::Options *cls = write_options.cast<ImageWriter::Options *>();
